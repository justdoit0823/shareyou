...
K.options = {
	...
	loadStyleMode : true,
	basePath : K.basePath,
	themesPath : K.basePath + 'images/default/',
	langPath : K.basePath ,
...
_each(('formatblock,justifyleft,justifycenter,justifyright,insertorderedlist,' +
	'insertunorderedlist,indent,outdent,subscript,superscript').split(','), function(i, name) {
	KCmd.prototype[name] = function(val) {
		var self = this;
		self.select();
		_nativeCommand(self.doc, name, val);
		if (!_IE || _inArray(name, 'formatblock,insertorderedlist,insertunorderedlist'.split(',')) >= 0) {
			self.selection();
		}
		return self;
	};
...
function _getInitHtml(themesPath, bodyClass, cssPath, cssData) {
	var arr = [
		...
		'	background-image:url(' + themesPath + 'images/default/flash.gif);',
		...
		'img.ke-rm {',
		'	border:1px solid #AAA;',
		'	background-image:url(' + themesPath + 'images/default/rm.gif);',
		'	background-position:center center;',
		'	background-repeat:no-repeat;',
		'	width:100px;',
		'	height:100px;',
		...
		'img.ke-media {',
		'	border:1px solid #AAA;',
		'	background-image:url(' + themesPath + 'images/default/media.gif);',
		'	background-position:center center;',
		'	background-repeat:no-repeat;',
		'	width:100px;',
		'	height:100px;',
...
KEditor.prototype = {
	...
	loadPlugin : function(name, fn) {
		...
		self.isLoading = true;
		_loadScript(self.pluginsPath + 'js/' + name + '.js?ver=' + encodeURIComponent(K.DEBUG ? _TIME : _VERSION), function() {
			self.isLoading = false;
			if (_plugins[name]) {
	...
	create : function() {
		...
		container.removeClass('container')
			.addClass('ke-container ke-container-' + self.themeType).css('width', '820px');
		if (fullscreenMode) {
			container.css({
				position : 'absolute',
				left : 0,
...
_plugin('core', function(K) {
	...
	_each('link,image,media'.split(','), function(i, name) {
	...
	self.addContextmenu({ title : '-' });
	_each(('selectall,justifyleft,justifycenter,justifyright,insertorderedlist,' +
		'insertunorderedlist,indent,outdent,subscript,superscript,hr,' +
	...
	self.beforeSetHtml(function(html) {
		return html.replace(/<embed[^>]*type="([^"]+)"[^>]*>(?:<\/embed>)?/ig, function(full) {
			...
			return _mediaImg(self.themesPath + 'images/default/blank.gif', attrs);
		})
